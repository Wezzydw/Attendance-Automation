...
public class StudentViewController implements Initializable
{
    ...
    /**
     * Metoden undersøger den valgte property og viser om der bliver valgt
     * absent eller present.
     *
     * @param event
     */
    @FXML
    private void handleRegister(ActionEvent event)
    {
        ...
        if (radio != null)
        {
            ...
            {
                System.out.println("Error registering attendance for: " + student.getFirstName() + " "+ student.getLastName() + "... " + ex);
            }
        }
    ...
    /**
     * Metoden holder styr på fraværsknapperne (present) så kun 1 kan være aktiv
     * af gangen
     *
     * @param event
     */
    ...
    /**
     * Metoden holder styr på fraværsknapperne (absent) så kun 1 kan være aktiv
     * af gangen
     *
     * @param event
     */
    ...
    /**
     * Metoden viser dataen i venstre kolonne af viewet, indeholder students og
     * klasser
     */
